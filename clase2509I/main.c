...
int menuInformes()
{
    ...
    system("cls");
    printf("*********Informes*****\n\n");
    printf("0- Mostrar alumnos de una carrera\n");
    printf("1-Mostrar alumnos por carrera\n");
    printf("2- Mostrar cantidad de alumnos por carrera\n");
    printf("3- Mostrar la carrera con màs inscriptos\n");
...
void mostrarAlumnosDeunaCarrera(eAlumno alumnos[], int tam, eCarrera carreras[], int tamC)
{
    ...
    {
    case 1:
        mostrarAlumnosCarrera(alumnos,tam,carreras,tamC,1000);
        break;
    case 2:
        mostrarAlumnosCarrera(alumnos,tam,carreras,tamC,1001);
        break;
    case 3:
        mostrarAlumnosCarrera(alumnos,tam,carreras,tamC,1002);
        break;
    default:
        printf("Opcion invalida\n");
    }
...
void mostrarAlumnosCarrera (eAlumno alumnos[], int tam, eCarrera carreras[], int tamC, int id)
{
    ...
    for(int i=0; i<tam; i++)
    {
        ...
        if(!alumnos[i].isEmpty &&id == alumnos[i].idCarrera)
        {
    ...
    if(!flag)
    {
        ...
        printf("No hay alumno que mostrar de la carrera %s\n",desc);
...
for(int i=0; i<tamC; i++){
    ...
    for(int j=0; i<tam;j++){
        if(!alumnos[j].isEmpty && alumnos[j].idCarrera==carreras[i].id){
            contador++;
        }
