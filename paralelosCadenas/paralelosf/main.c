...
void ordenarAlumnosSex(char nom[][20], int leg[], int age[], char sex[], int n1[], int n2[], float prom[], int tam);
void ordenarAlumnosSexLeg( char nom[][20], int leg[], int age[], char sex[], int n1[], int n2[], float prom[], int tam);
void ordenarNombres( char nom[][20],  int leg[], int age[], char sex[], int n1[], int n2[], float prom[], int tam);
...
int main()
{
   ...
   /* for(int i = 0; i < TAM; i++){
    ...
    ordenarAlumnosSex(nombres, legajos, edades, sexos, notasp1, notasp2, promedios, TAM);

    mostrarAlumnos(nombres, legajos, edades, sexos, notasp1, notasp2, promedios, TAM);

  ordenarAlumnosSexLeg(nombres,legajos, edades, sexos, notasp1, notasp2, promedios, TAM);
